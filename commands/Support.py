...
class Support(commands.Cog, name="Support"):
    ...
    @app_commands.command(name="support", description="Support me by donating through PayPal (Sandbox)")
    async def support(self, interaction: discord.Interaction):
        # Create a button for the user to input custom amount
        view = SupportView()
        await interaction.response.send_message("Click the button to support me (Sandbox mode)!", view=view)
